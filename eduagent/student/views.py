...
from .models import VideoLesson, Task
from .serializers import VideoLessonSerializer, TaskSerializer
...
class StudentTaskViewSet(viewsets.ModelViewSet):
    ...
    # swaggger uchun 100 % xatoni to'xtatadi
