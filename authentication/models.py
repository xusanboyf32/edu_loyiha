...
class CustomUserManager(BaseUserManager):
    ...
    # In CustomUserManager class, update create_user:
    def create_user(self, phone_number, email=None, role=None, **extra_fields):
    # ... (keep existing phone number validation)
        if email:
            extra_fields['email'] = email
    # ... (rest of the method)

# Update create_superuser:
...
class CustomUser(AbstractBaseUser, PermissionsMixin):
    ...
    # ----------------------------------------------------------------------------- #
    # In authentication/models.py, add this line in the CustomUser class fields:     
